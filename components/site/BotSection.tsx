      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-[1fr_1.1fr] gap-10 lg:gap-16 items-center">
        <div>
          ...
          <p className="mt-5 text-gray-600 text-base md:text-lg leading-relaxed max-w-md">
            Заполните анкету ниже. Менеджер позвонит, уточнит культуры и откроет доступ. После этого каждое утро бот в Telegram спрашивает цену и свободный объём по вашим культурам — ответ одним сообщением, например «31500 200».
          </p>
          <ul className="mt-6 space-y-2.5 text-gray-600">
            ...
            <li>• Бот узнаёт вас по телефону из анкеты — кнопка «Отправить номер».</li>
          </ul>
