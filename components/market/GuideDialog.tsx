...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    text: "В личном кабинете нажмите на цену в стакане. Экспортёр и агент — на цену предприятия и указывают объём. Предприятие — на заявку покупателя: она закрывается целиком. Запрос придёт менеджеру, сделку проводит АгроСфера.",
