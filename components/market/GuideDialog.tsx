...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    text: "Экспортёру и агенту — нажмите на цену предприятия. Предприятию — на заявку покупателя. Для этого войдите в личный кабинет — действия доступны проверенным участникам. Запрос придёт менеджеру: он сведёт стороны и проведёт сделку через АгроСферу.",
    image: "/guide/6-deal.webp",
  },
  {
    title: "Поставьте свою заявку",
    text: "Не нашли подходящей цены? Нажмите «Поставить заявку в стакан»: цена, объём, регионы. После проверки менеджером заявка появится в стакане. Когда цена предприятия совпадёт с вашей, менеджер свяжется с обеими сторонами.",
    image: "/guide/7-bid.webp",
  },
  {
    title: "Предприятию: цены в кабинете и в боте",
    text: "Зарегистрируйтесь в личном кабинете. После разговора с менеджером откроем доступ: цену можно подать в кабинете, а бот в Telegram каждое утро спросит цены по вашим культурам. Ответ — цена и объём, например «31500 200».",
    image: "/guide/8-bot.webp",
    link: { label: "Зарегистрироваться", href: "/kabinet/?role=producer" },
  },
];
